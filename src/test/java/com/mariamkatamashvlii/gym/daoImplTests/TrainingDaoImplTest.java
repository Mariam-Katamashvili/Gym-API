...
//
//        training = new Training(1L, 2L, "YogaSession", trainingType, Date.of(2022, 1, 1), 1.5f);
//    }
//
//    @Test
...
////        Training newTraining = new Training(3L, 4L, "YogaSession", new TrainingType("Pilates"), Date.of(2022, 2, 2), 2.0f); // Same training name
